              ...
              rows: List.generate(
                ...
                (index) => DataRow(
                  selected: controller.isChecked
                      .contains(controller.absentDisplayData[index].staffID),
                  onSelectChanged: (val) {
                    if (val!) {
                      controller.isChecked
                          .add(controller.absentDisplayData[index].staffID);
                    } else {
                      controller.isChecked
                          .remove(controller.absentDisplayData[index].staffID);
                    }
                    controller.tableSelect = val;
                  },
                  color: index.isEven
